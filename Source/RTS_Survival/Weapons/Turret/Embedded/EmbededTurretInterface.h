...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintImplementableEvent, Category = "Turret|Angle")
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintImplementableEvent, Category = "Turret|Angle")
	void UpdateTargetPitch(const float NewPitch);
	 ...
	 * that an animation needs to be playd we cannot simply use the PlayAnimation function from the weapon owner (this turret)
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintImplementableEvent, Category = "Turret|Animation")
	void PlaySingleFireAnimation(const int WeaponIndex);
	 ...
	 */
	UFUNCTION(BlueprintCallable, BlueprintImplementableEvent, Category = "Turret|Animation")
	void PlayBurstFireAnimation(const int WeaponIndex);
};
