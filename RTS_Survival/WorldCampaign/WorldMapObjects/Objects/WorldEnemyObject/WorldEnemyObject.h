...
public:
	...
	/**
	 * @brief Gets the runtime/save-game fortification modifier component for this enemy object.
	 ...
	 * @return Base fortification strength percentage for this enemy object.
	 */
...
private:
	 ...
	 * @return Enemy map item UI data for the current object state.
	 */
