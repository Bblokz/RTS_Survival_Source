...
USAVIOR_OpenLevel* USAVIOR_OpenLevel::OpenLevel(UObject* Context, AHUD_SaviorUI* HUD, USavior* Slot, TSoftObjectPtr<UWorld> LevelToOpen, bool Absolute, FString Options)
{
	...
	//
	OBJ->IsAbsolute = Absolute;
	OBJ->InOptions = Options;
	//
...
{
	if (Target == nullptr || !Target->IsValidLowLevelFast())
	{
		FFrame::KismetExecutionMessage(TEXT("[SAVIOR]: Invalid Target Slot."), ELogVerbosity::Error);
		return;
	}
	if (Outer == nullptr || Outer->GetWorld() == nullptr)
	{
		FFrame::KismetExecutionMessage(TEXT("[SAVIOR]: Invalid Target World."), ELogVerbosity::Error);
		return;
	}
	if (SHUD == nullptr || SHUD->GetWorld() == nullptr)
	{
		FFrame::KismetExecutionMessage(TEXT("[SAVIOR]: Invalid Target HUD."), ELogVerbosity::Error);
		return;
	}
	//
	Execute();
...
void USAVIOR_OpenLevel::Execute()
{
	switch (Target->LoadScreenMode)
	{
		...
		{
			SHUD->DisplayBlurLoadScreenHUD(EThreadSafety::SynchronousLoading, Target->FeedbackLOAD, Target->FeedbackFont,
				Target->ProgressBarTint, Target->BackBlurPower);
		}
		break;
		//
		case ELoadScreenMode::SplashScreen:
		{
			SHUD->DisplaySplashLoadScreenHUD(EThreadSafety::SynchronousLoading, Target->FeedbackLOAD, Target->FeedbackFont,
				Target->ProgressBarTint, Target->SplashImage, Target->SplashStretch);
		}
		break;
		//
		case ELoadScreenMode::MoviePlayer:
		{
			SHUD->DisplayMovieLoadScreenHUD(EThreadSafety::SynchronousLoading, Target->FeedbackLOAD, Target->FeedbackFont,
				Target->ProgressBarTint, Target->SplashMovie, Target->ProgressBarOnMovie);
		}
		break;
		default:
			break;
	...
	//
	UGameplayStatics::OpenLevel(Outer, Level, IsAbsolute, InOptions);
}

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// Open Level [+Callbacks]:

USAVIOR_OpenLevel_Callback* USAVIOR_OpenLevel_Callback::OpenLevel(UObject* Context, AHUD_SaviorUI* HUD, USavior* Slot,
	TSoftObjectPtr<UWorld> LevelToOpen, bool Absolute, FString Options,
	const FBeginDATA& OnOpenCallback)
{
...
USAVIOR_SaveGameWorld* USAVIOR_SaveGameWorld::SaveGameWorld(USavior* Savior, UObject* Context, const bool SaveSlotMeta)
{
	...
	if (Savior)
	{
		if (!Savior->IsInstance())
		{
			ESaviorResult Result;
			OBJ->Target = USavior::NewSlotInstance(Context, Savior, Result);
		}
		else
		{
			OBJ->Target = Savior;
...
USAVIOR_SaveGameWorld_Callback* USAVIOR_SaveGameWorld_Callback::SaveGameWorld(USavior* Savior, UObject* Context,
...
USAVIOR_LoadGameWorld* USAVIOR_LoadGameWorld::LoadGameWorld(USavior* Savior, UObject* Context,
	const bool ResetLevelOnLoad, bool Absolute, FString Options)
{
...
void USAVIOR_LoadGameWorld::Execute()
{
	ESaviorResult Result;
	//
	Target->LoadGameWorld(Outer, ResetLevel, IsAbsolute, InOptions, Result);
}
...
USAVIOR_LoadGameWorld_Callback* USAVIOR_LoadGameWorld_Callback::LoadGameWorld(USavior* Savior, UObject* Context,
	const bool ResetLevelOnLoad,
...
USAVIOR_SaveLevel* USAVIOR_SaveLevel::SaveLevel(USavior* Savior, TSoftObjectPtr<UWorld> LevelToSave, UObject* Context,
...
USAVIOR_SaveLevel_Callback* USAVIOR_SaveLevel_Callback::SaveLevel(USavior* Savior, TSoftObjectPtr<UWorld> LevelToSave,
	UObject* Context, const bool SaveSlotMeta,
	const bool		  WriteSlotFile,
	const FBeginDATA& BeganSaveCallback,
	const FEndDATA&	  FinishedSaveCallback)
{
...
USAVIOR_LoadLevel* USAVIOR_LoadLevel::LoadLevel(USavior* Savior, TSoftObjectPtr<UWorld> LevelToLoad, UObject* Context,
...
USAVIOR_LoadLevel_Callback* USAVIOR_LoadLevel_Callback::LoadLevel(USavior* Savior, TSoftObjectPtr<UWorld> LevelToLoad,
	UObject* Context, const bool StreamLevelOnLoad,
	const bool		  ReadSlotFile,
	const FBeginDATA& BeganLoadCallback,
	const FEndDATA&	  FinishedLoadCallback)
{
...
USAVIOR_SaveGameMode* USAVIOR_SaveGameMode::SaveGameMode(USavior* Savior, UObject* Context, const bool SaveSlotMeta,
	const bool WithGameInstance)
{
...
USAVIOR_SaveGameMode_Callback* USAVIOR_SaveGameMode_Callback::SaveGameMode(USavior* Savior, UObject* Context,
	const bool		  SaveSlotMeta,
	const bool		  WithGameInstance,
	const FBeginDATA& BeganSaveCallback,
	const FEndDATA&	  FinishedSaveCallback)
...
USAVIOR_LoadGameMode* USAVIOR_LoadGameMode::LoadGameMode(USavior* Savior, UObject* Context,
	const bool IgnoreMainPawnTransform,
	const bool WithGameInstance)
{
...
USAVIOR_LoadGameMode_Callback* USAVIOR_LoadGameMode_Callback::LoadGameMode(USavior* Savior, UObject* Context,
	const bool		  IgnoreMainPawnTransform,
	const bool		  WithGameInstance,
	const FBeginDATA& BeganLoadCallback,
	const FEndDATA&	  FinishedLoadCallback)
...
USAVIOR_SaveGameInstance* USAVIOR_SaveGameInstance::SaveGameInstance(USavior* Savior, UObject* Context,
	const bool SaveSlotMeta)
{
...
USAVIOR_SaveGameInstance_Callback* USAVIOR_SaveGameInstance_Callback::SaveGameInstance(
	USavior* Savior, UObject* Context, const bool SaveSlotMeta, const FBeginDATA& BeganSaveCallback,
	const FEndDATA& FinishedSaveCallback)
{
...
USAVIOR_LoadGameInstance* USAVIOR_LoadGameInstance::LoadGameInstance(USavior* Savior, UObject* Context)
{
...
USAVIOR_LoadGameInstance_Callback* USAVIOR_LoadGameInstance_Callback::LoadGameInstance(
	USavior* Savior, UObject* Context, const FBeginDATA& BeganLoadCallback, const FEndDATA& FinishedLoadCallback)
{
